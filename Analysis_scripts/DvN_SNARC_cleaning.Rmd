...
```{r}
dat_missing <- read_excel(here::here("DvN_manuscript_analysis/Data/Session1.xlsx"))
dat <- read_excel(here::here("DvN_manuscript_analysis/Data/Session2_combine.xlsx"), 2)
```
